...
<div class="container">
  ...
  <h3>1. ¿Con qué frecuencia has tenido dificultades económicas que afectan tu vida universitaria?</h3>
  <p>Como pagar la matrícula, comprar materiales, transporte o comida durante el semestre.</p>
      <div class="opciones">
        <label class="opcion">
  ...
  <h3>2. ¿Te ha pasado que te cuesta entender las materias o conceptos que se ven en tus clases?</h3>
  <p>Piensa en las dificultades para seguir las explicaciones o hacer tareas.</p>
      <div class="opciones">
        <label class="opcion">
  ...
  <h3>3. ¿Has sentido ansiedad, estrés o tristeza que te dificultan concentrarte en tus estudios?</h3>
  <p>Por ejemplo, durante exámenes o cuando tienes muchas tareas.</p>
      <div class="opciones">
        <label class="opcion">
  ...
  <h3>4. ¿Sientes que te falta motivación o ganas para seguir con tu carrera?</h3>
  <p>Como que no te entusiasma lo que estás estudiando.</p>
      <div class="opciones">
        <label class="opcion">
  ...
  <h3>5. ¿Tus responsabilidades en casa o con tu familia afectan tu tiempo para estudiar?</h3>
  <p>Por ejemplo, cuidar a alguien o hacer tareas domésticas.</p>
      <div class="opciones">
        <label class="opcion">
  ...
  <h3>6. ¿Crees que tu carrera no es lo que esperabas o no te gusta como pensabas?</h3>
  <p>Piensa si te gustaría cambiar o hacer otra cosa.</p>
      <div class="opciones">
        <label class="opcion">
    ...
    <div class="pregunta" id="pregunta-8">
      <h3>7. ¿Te cuesta hacer amigos o sentirte parte de la universidad?</h3>
      <p>Como participar en actividades o sentir que encajas.</p>
      <div class="opciones">
        <label class="opcion">
    ...
    <div class="pregunta" id="pregunta-9">
      <h3>8. ¿En los últimos meses has pensado en dejar la universidad o cambiar de carrera?</h3>
      <p>Piensa en si has contemplado seriamente la posibilidad de dejar la universidad.</p>
      <div class="opciones">
        <label class="opcion">
    ...
    <div class="pregunta" id="pregunta-10">
      <h3>9. ¿Te cuesta organizar tu tiempo para estudiar, hacer tareas y preparar exámenes?</h3>
      <div class="opciones">
        <label class="opcion">
    ...
    <div class="pregunta" id="pregunta-11">
      <h3>10. ¿Sientes que no recibes suficiente apoyo de tus profesores o de la institución?</h3>
      <p>Considera si tienes acceso a tutorías, asesorías o apoyo cuando lo necesitas.</p>
      <div class="opciones">
        <label class="opcion">
